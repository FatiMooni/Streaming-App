 ...
 **/
interface StreamingSource : Iterable<MediaMetadataCompat> {
     ...
     */
    abstract class AbstractStreamingSource : StreamingSource {
        @State
        ...
        override fun search(query: String, extras: Bundle): List<MediaMetadataCompat> {
            ...
            val focusSearchResult = when (extras[MediaStore.EXTRA_MEDIA_FOCUS]) {
                ...
                MediaStore.Audio.Albums.ENTRY_CONTENT_TYPE -> {
                    ...
                    filter { song ->
                        (song.artist == artist || song.albumArtist == artist) && song.station == album
                    }
                }
