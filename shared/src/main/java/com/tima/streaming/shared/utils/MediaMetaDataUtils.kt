...
/**
 * Useful extensions for [MediaMetadataCompat] that will get along with our app.
 */
...
inline val MediaMetadataCompat.station: String?
...
inline val MediaMetadataCompat.picture: Bitmap
    get() = getBitmap(MediaMetadataCompat.METADATA_KEY_ART)

inline val MediaMetadataCompat.pictureUri: Uri
    get() = this.getString(MediaMetadataCompat.METADATA_KEY_ART_URI).toUri()

//since that we don't have albums
inline val MediaMetadataCompat.stationPicture: Bitmap?
    get() = getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART)

inline val MediaMetadataCompat.stationPictureUri: Uri
...
inline var MediaMetadataCompat.Builder.station: String?
    @Deprecated(NO_GET, level = DeprecationLevel.ERROR)
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
...
inline var MediaMetadataCompat.Builder.stationPictureUri: String?
    @Deprecated(NO_GET, level = DeprecationLevel.ERROR)
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
...
inline var MediaMetadataCompat.Builder.stationPicture: Bitmap?
    @Deprecated(NO_GET, level = DeprecationLevel.ERROR)
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
